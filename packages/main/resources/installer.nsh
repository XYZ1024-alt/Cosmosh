...
; Keep the installer crisp on high-DPI and mixed-DPI Windows displays.
; NSIS does not opt into DPI awareness by default, so Windows otherwise bitmap-scales
; the assisted installer window and makes the classic controls look blurry.
!macro customHeader
