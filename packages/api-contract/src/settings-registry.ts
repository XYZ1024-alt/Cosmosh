...
export interface SettingsValues {
  ...
  terminalContextLaunchBehavior:
    | "openDefaultLocalTerminal"
    | "openLocalTerminalList"
    | "off";
...
export const SETTINGS_REGISTRY: ReadonlyArray<SettingDefinition> = [
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAltClickMovesCursor.description",
    category: SETTINGS_CATEGORIES.theme,
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalCursorInactiveStyle.description",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalSelectionBarEnabled.description",
    category: SETTINGS_CATEGORIES.terminal,
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalContextLaunchBehavior.description",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.defaultLocalTerminalProfile.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.runtime,
    control: "select",
    path: "terminal.runtime.defaultLocalTerminalProfile",
    commandActionId:
      "settings.terminal.runtime.defaultLocalTerminalProfile.set",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalSelectionSearchEngine.description",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalSelectionSearchUrlTemplate.description",
    placeholderI18nKey:
      "settings.items.terminalSelectionSearchUrlTemplate.placeholder",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.search,
    control: "input",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompleteEnabled.description",
    category: SETTINGS_CATEGORIES.terminal,
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompleteHistoryEnabled.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "switch",
    path: "terminal.runtime.autoComplete.history.enabled",
    commandActionId:
      "settings.terminal.runtime.autoComplete.history.enabled.toggle",
  ...
  },
  {
    ...
    defaultValue: true,
    nameI18nKey:
      "settings.items.terminalAutoCompleteBuiltInCommandsEnabled.title",
    descriptionI18nKey:
      "settings.items.terminalAutoCompleteBuiltInCommandsEnabled.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "switch",
    path: "terminal.runtime.autoComplete.builtinCommands.enabled",
    commandActionId:
      "settings.terminal.runtime.autoComplete.builtinCommands.enabled.toggle",
    searchTerms: [
      "terminal",
      "autocomplete",
      "builtin commands",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompletePathEnabled.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "switch",
    path: "terminal.runtime.autoComplete.path.enabled",
    commandActionId:
      "settings.terminal.runtime.autoComplete.path.enabled.toggle",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompletePasswordEnabled.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "switch",
    path: "terminal.runtime.autoComplete.password.enabled",
    commandActionId:
      "settings.terminal.runtime.autoComplete.password.enabled.toggle",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompleteMinChars.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "input",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompleteMaxItems.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "input",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalAutoCompleteFuzzyMatch.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.autoComplete,
    control: "switch",
    path: "terminal.advanced.autoComplete.fuzzyMatch",
    commandActionId:
      "settings.terminal.advanced.autoComplete.fuzzyMatch.toggle",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalDrawBoldTextInBrightColors.description",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.advancedTerminal,
    control: "switch",
    path: "terminal.advanced.drawBoldTextInBrightColors",
    commandActionId:
      "settings.terminal.advanced.drawBoldTextInBrightColors.toggle",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalFastScrollSensitivity.description",
    placeholderI18nKey:
      "settings.items.terminalFastScrollSensitivity.placeholder",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.advancedTerminal,
    control: "input",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalMinimumContrastRatio.description",
    placeholderI18nKey:
      "settings.items.terminalMinimumContrastRatio.placeholder",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.advancedTerminal,
    control: "input",
  ...
  },
  {
    ...
    descriptionI18nKey:
      "settings.items.terminalSmoothScrollDuration.description",
    placeholderI18nKey:
      "settings.items.terminalSmoothScrollDuration.placeholder",
    category: SETTINGS_CATEGORIES.terminal,
    section: SETTINGS_CATEGORIES.terminal.sections.advancedTerminal,
    control: "input",
...
export const SETTINGS_DEFINITION_MAP: ReadonlyMap<
  SettingKey,
  SettingDefinition
> = new Map(SETTINGS_REGISTRY.map((item) => [item.key, item]));

// Reverse lookup: category object → category ID string.
const CATEGORY_ID_MAP = new Map<SettingsCategory, SettingsCategoryId>(
  (
    Object.entries(SETTINGS_CATEGORIES) as [
      SettingsCategoryId,
      SettingsCategory,
    ][]
...
export const getVisibleCategories = (
  ...
  const presentCategories = new Set(
    settings
      .map((item) => resolveCategoryId(item.category))
      .filter((id): id is SettingsCategoryId => id !== undefined),
  );
