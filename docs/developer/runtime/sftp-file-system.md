...
- CodeMirror preview keyboard shortcuts, including `Ctrl`/`Cmd+S` save, stay scoped to the editor. SFTP page-level file-list shortcuts ignore events that originate from editor, text-input, or contenteditable targets.
